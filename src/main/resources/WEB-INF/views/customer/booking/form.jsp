...
<acme:form>
	<acme:input-textbox code="customer.booking.form.label.locatorCode" path= "locatorCode" placeholder="customer.booking.form.placeholder.locatorCode"/>
	...
	<jstl:choose>
		...
		<jstl:when test="${acme:anyOf(_command, 'show|update|publish|delete') && draftMode == true}">
			...
			<acme:button code="customer.booking.form.button.passengers" action="/customer/booking-passenger/list?bookingId=${id}"/>
		</jstl:when>
