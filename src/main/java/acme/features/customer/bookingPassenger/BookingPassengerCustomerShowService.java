...
@GuiService
public class BookingPassengerCustomerShowService extends AbstractGuiService<Customer, BookingPassenger> {
	...
	public void load() {
		...
		BookingPassenger BookingPassengers = this.bookingPassengerCustomerRepository.getBookingPassengerByBookingPassengerId(id);
