...
@GuiService
public class BookingPassengerCustomerListService extends AbstractGuiService<Customer, BookingPassenger> {
	...
	public void load() {
		...
		Collection<BookingPassenger> BookingPassengers = this.bookingPassengerCustomerRepository.getBookingPassengersByCustomerId(customerId);
